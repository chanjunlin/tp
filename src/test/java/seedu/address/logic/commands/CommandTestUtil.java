...
public class CommandTestUtil {
    ...
    public static final String VALID_DOB_AMY = "01/01/2001";
    public static final String VALID_DOB_BOB = "09/08/1965";
    ...
    public static final String BLOOD_TYPE_AMY = " " + PREFIX_BLOODTYPE + VALID_BLOOD_TYPE_AMY;
    public static final String BLOOD_TYPE_BOB = " " + PREFIX_BLOODTYPE + VALID_BLOOD_TYPE_BOB;
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY).withDOB(VALID_DOB_AMY)
        ...
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB).withDOB(VALID_DOB_BOB)
