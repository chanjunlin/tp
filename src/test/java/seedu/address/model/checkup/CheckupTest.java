...
public class CheckupTest {
    ...
    public void constructor_validInputs_createsCheckup() {
        ...
        try {
            Checkup checkup = new Checkup(checkupDate, checkupTime);
    ...
    public void constructor_outsideBusinessHours_throwsParseException() {
        ...
        assertThrows(ParseException.class, () -> new Checkup(checkupDate, checkupTime1));
        assertThrows(ParseException.class, () -> new Checkup(checkupDate, checkupTime2));
    }
    ...
    public void constructor_pastDate_throwsParseException() {
        ...
        LocalTime checkupTime = LocalTime.of(10, 0);
        assertThrows(ParseException.class, () -> new Checkup(checkupDate, checkupTime));
    }
